	...
	<div class="media">
		...
		<?php endif; ?>
			...
			*/
			...
			$id = get_the_id();
			$img_url = wp_get_attachment_image_src( get_post_thumbnail_id($id), 'full', false, '' );
			$n_img = aq_resize( $img_url[0], $width =260, $height = 360, $crop = true, $single = true, $upscale = true );?>
			<img src=" <?php echo esc_url( $n_img );?>" />
