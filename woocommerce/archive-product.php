...
<?php $shop_layout = $bella_options['shop_layout'];
      $shop_class  = ($shop_layout == 'full-width')? 'col-md-12' : 'col-sm-9'; ?>
		...
		<section class="page-section with-sidebar">
			...
			*/
			...
			<div class="<?php echo $shop_class; ?> content" id="content">
				...
				<?php if (have_posts() ) : $i=1;?>
					...
					*/
					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<?php if( $shop_layout!= 'list-view' ):?>

							<div class="<?php if($shop_layout != 'full-width') echo 'col-md-4'; else echo 'col-md-3';?> col-sm-6 grid-item">

								<?php wc_get_template_part( 'content', 'product' ); ?>

							</div> 
							<?php 
								if( $shop_layout == 'full-width' && $i%4== 0) echo '<div class="clearfix"></div>';
									  
							    if( $shop_layout != 'full-width' && $i%3== 0) echo '<div class="clearfix"></div>'; ?>
